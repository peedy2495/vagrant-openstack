...
# swift rollout: proxy
source $ASSETS/swift/swift-proxy.sh > >(tee -a /var/log/deployment/swift-proxy.log) 2> >(tee -a /var/log/deployment/swift-proxy.err >&2)
...
# maila rollout: share
source $ASSETS/manila/manila-storagenode. > >(tee -a /var/log/deployment/manila-storage.log) 2> >(tee -a /var/log/deployment/manila-storage.err >&2)